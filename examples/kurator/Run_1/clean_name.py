...
def clean_scientific_name():  
    ...
    YWDir = CurrentRunDir + '/' +'/yw'
    CSVDir = YWDir + '/' + 'csv'
    os.makedirs(YWDir)
    os.makedirs(CSVDir)
    copy_file('yw_clean_name.properties',YWDir+'/yw.properties')
    copy_file('clean_name.py',CurrentRunDir)
    
    input1_data_file_name='../all_inputs/demo_input_1.csv'
    copy_file(input1_data_file_name,CurrentRunDir)
    local_authority_source_file_name='../all_inputs/demo_localDB.csv'
